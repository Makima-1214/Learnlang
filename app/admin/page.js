...
const ShieldIcon = () => (
  <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none">
    <path
      d="M12 2L4 6v5c0 5.5 3.5 10.7 8 12 4.5-1.3 8-6.5 8-12V6L12 2z"
      fill="white"
      opacity="0.3"
      stroke="white"
      strokeWidth="2"
...
const BookIcon = () => (
  <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none">
    ...
    />
    <path
      d="M6.5 3H20v18H6.5A2.5 2.5 0 0 1 4 19.5v-14A2.5 2.5 0 0 1 6.5 3z"
      fill="white"
      opacity="0.3"
      stroke="white"
      strokeWidth="2"
...
const CrownIcon = () => (
  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none">
    <path
      d="M3 18h18M5 18l2-8 5 4 5-8 2 8"
      stroke="#FBBF24"
      strokeWidth="2.2"
      strokeLinecap="round"
      strokeLinejoin="round"
      ...
      <main className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          {[
            ...
            >
              <div
                className={`bg-gradient-to-br ${stat.color} p-3 rounded-2xl w-fit mb-4 shadow-md`}
              >
                {stat.icon}
              </div>
                ...
                exercisesByMode.map((mode, i) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-3 h-3 rounded-full ${mode.method === "vocabulary" ? "bg-indigo-500" : mode.method === "grammar" ? "bg-emerald-500" : "bg-pink-500"}`}
                      />
                      <span className="font-black text-gray-700">
                        {mode.method === "vocabulary"
                          ? "Vocabulary"
                          : mode.method === "grammar"
                            ? "Grammar"
                            : mode.method || "Unknown"}
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-gray-400">
                  Pengguna paling aktif (7 hari terakhir)
                </p>
              </div>
            </div>
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-2xl w-8 text-center">
                        {i === 0 ? (
                          ...
                          <span className="font-black text-gray-400 text-base">
                            #{i + 1}
                          </span>
                        )}
                      </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-right">
                        <div className="text-2xl font-black text-indigo-600">
                          {learner._count.learningSessions}
                        </div>
                        <div className="text-xs font-bold text-gray-400">
                          latihan
                        </div>
